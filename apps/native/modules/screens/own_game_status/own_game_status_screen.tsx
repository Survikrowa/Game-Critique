...
export const OwnGameStatusScreen = () => {
    ...
    >
      ...
      <View className="pb-10" style={{ gap: 16, marginTop: -2 }}>
        ...
        <Pressable
          ...
          className="mx-4 min-h-[44px] flex-row items-center justify-center gap-2 rounded-full bg-background-100"
        >
