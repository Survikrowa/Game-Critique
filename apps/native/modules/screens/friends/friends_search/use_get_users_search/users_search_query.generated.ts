...
export type UsersSearchQuery = { __typename?: 'Query', usersSearch: Array<{ __typename?: 'UserSearchResultDTO', oauthId: string, isFriendRequestSent: boolean, profile?: { __typename?: 'ProfileDTO', id: number, name?: string | null, avatarUrl: string } | null }> };
